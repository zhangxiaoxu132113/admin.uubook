...
<script>
    ...
    $('.table-sort').dataTable({
        ...
        ajax: {
            "type": "POST",
            "url": '../category/findCategoryByCondition',
        ...
        "columns": [
            ...
            {"data": "name", "title": "分类名称", "width": "130"},//"orderable": false是否可排序（true界面上会有排序按钮）
            {"data": "parentName", "title": "父级分类", "width": "130"},//"orderable": false是否可排序（true界面上会有排序按钮）
            {
                "data": "picUrl",
                "title": "封面",
                'sClass': "text-center",
